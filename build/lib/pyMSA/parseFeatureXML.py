...
class Reader():
    """
    Generator object with functions to acces information from featureXML files easily. 
    Reader() applies a __getitem__ functio so information can be retrieved from the feature elements
    ...
    def getNonFeatureElements(self):
        """
