...
def main():
    ...
    # list of all the files I want to add
    featureXML_jg_c1 = ['/homes/dmamartin/Documents/PROTEOMICS/Cantrell/openMS/JG-C1-1.raw.i_c1000.featureXML',
                        ...
                        '/homes/dmamartin/Documents/PROTEOMICS/Cantrell/openMS/JG-C1-1.raw.i_c2500.featureXML',
    ...
    featureXML_jg_c1a = ['/homes/dmamartin/Documents/PROTEOMICS/Cantrell/openMS/JG-C1-1A.raw.i_c1000.featureXML',
                        ...
                        '/homes/dmamartin/Documents/PROTEOMICS/Cantrell/openMS/JG-C1-1A.raw.i_c2500.featureXML',
    ...
    featureXML_jg_c18 = ['/homes/ndeklein/analysis/featureXML/JG-C1-18.raw.i_c1000.featureXML',
                        '/homes/ndeklein/analysis/featureXML/JG-C1-18.raw.i_c1500.featureXML',
                        '/homes/ndeklein/analysis/featureXML/JG-C1-18.raw.i_c2000.featureXML',
                        '/homes/ndeklein/analysis/featureXML/JG-C1-18.raw.i_c2500.featureXML',
                        '/homes/ndeklein/analysis/featureXML/JG-C1-18.raw.i_c3000.featureXML',
                        '/homes/ndeklein/analysis/featureXML/JG-C1-18.raw.i_c3500.featureXML',
                        '/homes/ndeklein/analysis/featureXML/JG-C1-18.raw.i_c4000.featureXML']

    trafoXML_files = ['/homes/ndeklein/Cantrell/analysis_old/trafoXML/JG-C1-1__JG-C1-1A.raw.i_c1000__file_1.trafoXML',
                      ...
                      '/homes/ndeklein/Cantrell/analysis_old/trafoXML/JG-C1-1__JG-C1-1A.raw.i_c2500__file_1.trafoXML',
    ...
    old_trafoxml =   ['/homes/ndeklein/analysis/trafoXML/JG-C1-1__JG-C1-18.raw.i_c1000__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1__JG-C1-18.raw.i_c1500__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1__JG-C1-18.raw.i_c2000__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1__JG-C1-18.raw.i_c2500__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1__JG-C1-18.raw.i_c3000__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1__JG-C1-18.raw.i_c3500__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1__JG-C1-18.raw.i_c4000__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1A__JG-C1-18.raw.i_c1000__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1A__JG-C1-18.raw.i_c1500__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1A__JG-C1-18.raw.i_c2000__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1A__JG-C1-18.raw.i_c2500__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1A__JG-C1-18.raw.i_c3000__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1A__JG-C1-18.raw.i_c3500__file_2.trafoXML',
                      '/homes/ndeklein/analysis/trafoXML/JG-C1-1A__JG-C1-18.raw.i_c4000__file_2.trafoXML']





#    with database.ConnectSqlite('../database/m_pyMSA_database.db') as sqlCon:      
...
#        print 'It took',time.time()-time0,'seconds\n' 
#    
#    with database.FillDatabase('../database/pyMSA_database.db', 'JG-C1-18') as fd:       # make a FillDatabase instance with msrun named example, description of msrun 'example description' and default database
#        time0 = time.time()
#        try:
#            print 'doing fillMsrun'
#            fillDatabase.fillMsrun(jg_c18)
#        except pysqlite2.dbapi2.IntegrityError, e:
#            print 'msrun was already filled'
#            print e
#        print 'it took',time.time()-time0,'seconds'
#        time0 = time.time()
#        print 'fill spectrum'
#        mzmlInstance = pymzml.run.Reader(jg_c18)
#        fillDatabase.fillSpectrum(mzmlInstance)
#        print 'It took',time.time()-time0,'seconds\n'
#        featureXMLcount = 0                                                                             # fill the msrun table. msrun name is 'example'
#        for featureXML_path in featureXML_jg_c18:
#            print 'doing feature number:',featureXMLcount+1
#            time0 = time.time()
#            fillDatabase.fillFeatures(parseFeatureXML.Reader(featureXML_path), intensity_cutoff = float(featureXML_path.split('_c')[1].rstrip('.featureXML')))                                               # fill the other feature tables. 
#            print ' It took',time.time()-time0,'seconds\n'
